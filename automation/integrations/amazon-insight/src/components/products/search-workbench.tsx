            ...
            <div className="grid gap-4 md:grid-cols-4">
              <label className="space-y-2 text-sm text-slate-600">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-[var(--border)] bg-white/75 px-4 py-3 text-slate-900 outline-none"
                >
              ...
              <label className="flex items-center gap-3 rounded-xl border border-[var(--border)] bg-white/75 px-4 py-3 text-sm text-slate-700">
                <input
                  type="checkbox"
          ...
          >
            <div className="space-y-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <Link
                  href="/pool"
                  className="inline-flex items-center justify-center rounded-xl border border-[var(--border)] bg-white/80 px-4 py-3 text-sm font-medium text-slate-700 transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
                >
                  查看选品池
                </Link>
                <Link
...
function ProductCard({
  ...
  return (
    <article
      className={cn(
        "surface-card ambient-ring flex flex-col overflow-hidden rounded-2xl border p-5 transition",
