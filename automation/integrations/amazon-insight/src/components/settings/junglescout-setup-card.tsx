    ...
    >
      <div className="space-y-4">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div className="rounded-xl border border-[var(--border)] bg-white/70 px-4 py-3 text-sm text-[var(--foreground-soft)]">
        ...
        <div className="grid gap-3 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto]">
          <label className="space-y-2">
            ...
            <input
              ...
              placeholder="例如 test"
              className="w-full rounded-xl border border-[var(--border)] bg-white/80 px-4 py-3 text-sm text-slate-900 outline-none placeholder:text-slate-400"
            />
          </label>
          <label className="space-y-2">
          ...
          <div className="flex items-end">
            <button
              ...
              disabled={isPending}
              className="inline-flex min-h-[50px] items-center justify-center rounded-xl bg-[var(--accent)] px-5 text-sm font-semibold text-white transition hover:bg-[var(--accent-strong)] disabled:opacity-60"
            >
              {isPending ? "保存中..." : "保存"}
            </button>
          </div>
