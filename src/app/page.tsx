...
import { ArrowRight, Database, FolderKanban, Search } from "lucide-react";
    ...
    <div className="flex min-h-screen flex-col pb-16">
      ...
      <main className="flex-1 py-8 sm:py-10">
        <PageContainer className="space-y-8">
          <HeroPanel
            eyebrow="Amazon Selection Workbench"
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_380px]">
            <HomeSearchForm />
            <section className="surface-card ambient-ring rounded-[32px] border border-[var(--border)] p-6">
          ...
          <section className="grid gap-5 lg:grid-cols-3">
            {[
              ...
              <div key={item.title} className="surface-card ambient-ring rounded-[28px] border border-[var(--border)] p-6">
...
function QuickEntry({
  ...
  return (
    <Link
      href={href}
      className="ambient-ring flex items-start justify-between gap-4 rounded-[24px] border border-[var(--border)] bg-[var(--surface-strong)] p-5 transition hover:border-[var(--accent-soft-strong)] hover:bg-white/90"
    >
