    ...
    <div className="space-y-8">
      ...
      >
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1.1fr)_minmax(300px,.9fr)]">
          ...
          <div className="ambient-ring grid gap-4 rounded-[26px] border border-[var(--border)] bg-[var(--surface-strong)] p-5 sm:grid-cols-[116px_minmax(0,1fr)]">
            <div className="overflow-hidden rounded-[22px] border border-[var(--border)] bg-white/80">
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1.2fr)_380px]">
        <SectionCard eyebrow="Demand Trend" title="需求趋势" description="近 12 个月搜索走势。">
          <div className="rounded-[26px] border border-[var(--border)] bg-white/70 p-4">
      ...
      >
        {inspiration ? (
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,.95fr)]">
            ...
            <div className="rounded-[22px] border border-[var(--border)] bg-[rgba(255,255,255,.7)] p-5 text-sm text-slate-600">
...
function TrendChartFallback() {
  return (
    <div className="flex h-full items-center justify-center rounded-[22px] border border-dashed border-[var(--border)] bg-[rgba(255,255,255,.5)] text-sm text-slate-500">
      正在准备趋势图…
    </div>
  );
}
